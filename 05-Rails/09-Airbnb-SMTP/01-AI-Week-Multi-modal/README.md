...
Make sure to use the right model depending on the file content type, and to add the appropriate **validations** in your code to avoid processing too large files, to control your API consumption.
